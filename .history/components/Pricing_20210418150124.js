...
function Index() {
    return ( <
        ...
        <
        h1 className = "xl:text-4xl text-3xl text-center text-gray-800 mb-4 font-extrabold" > Simple & amp; Transparent Pricing < /h1> <
        p className = "text-xl text-center text-gray-600 leading-normal" > We grow when your business does.So we have put together simple pricing that allows you to easily scale your business when its needs evolve.So choose a plan
        ...
        p className = "text-sm text-center text-gray-600 pb-5 leading-normal px-10" > Basic resources
        for a starter site.Individuals and small teams. < /p> <
        ...
        <
        p className = "pl-2 text-gray-600 text-base" > Demo features 1
        for plan < /p> <
        /li> <
        li className = "flex items-center mb-8" >
        <
        ...
        p className = "text-sm text-center text-gray-600 pb-5 leading-normal px-10" > More power
        for company sites and heavy traffic.Growing business. < /p> <
        p className = "text-base text-center text-gray-600 font-bold" >
