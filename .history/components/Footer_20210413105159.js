...
const Footer = () => {
  return (
    ...
    <
    a href = "#"
    className = "font-normal text-base hover:text-gray-100" > Home < /a> < /
    li > <
    li >
    <
    a href = "#"
    className = "font-normal text-base hover:text-gray-100" > About us < /a> < /
    li > <
    li >
    <
    a href = "#"
    ...
    <
    a href = "#"
    className = "hover:text-gray-100" > suppo @company.com < /a> < /
    div > <
    /div> < /
    div > <
    /div> <
    ...
    a > <
    /div> <
    div className = "text-sm mt-4" > ©2021 Wasify Inc | All rights reserved. <
    /div> < /
    div > <
    /footer> < /
    div >
