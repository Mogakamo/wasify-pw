...
class Chat extends React.Component {
  ...
  <div style={{overscrollBehavior: 'none'}}>
    {/* HEADING */}
    <div className="fixed w-full bg-green-400 h-16 pt-2 text-white flex justify-between shadow-md" style={{top: 0, overscrollBehavior: 'none'}}>
      {/* back button */}
      <a href="#">
  ...
  {/* MESSAGE INPUT AREA */}
  <div className="fixed w-full flex justify-between bg-green-100" style={{bottom: 0}}>
