...
const Hero = () => {
  ...
  <div className="min-h-screen hero-image bg-right-bottom bg-cover flex" style={{backgroundImage: 'url(https://images.unsplash.com/photo-1457131760772-7017c6180f05?ixlib=rb-1.2.1&q=85&fm=jpg&crop=entropy&cs=srgb&ixid=eyJhcHBfaWQiOjE0NTg5fQ)'}}>
