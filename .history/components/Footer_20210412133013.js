...
const Footer = () => {
    return ( <
        ...
        alt = "UptimeMate logo" / >
        <
        p className = "mt-4" > Let our designs work
        for you.And save valuable time during your next business adventure. < /p> <
        /div> <
        div >
        <
        ...
        <
        a href = "#"
        className = "font-normal text-base hover:text-gray-100" > General Terms & amp; Conditions < /a> <
        /li> <
        li >
        <
        a href = "#"
        className = "font-normal text-base hover:text-gray-100" > Data Processing Agreement < /a> <
        /li> <
        li >
        <
        a href = "#"
        className = "font-normal text-base hover:text-gray-100" > Privacy Statement < /a> <
        /li> <
        /ul> <
        /nav> <
        /div> <
        ...
        d = "M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" / > < path strokeLinecap = "round"
        strokeLinejoin = "round"
        strokeWidth = {
            2
        }
        ...
        <
        a href = "#"
        className = "hover:text-gray-100" > support @company.com < /a> <
        /div> <
        /div> <
        /div> <
        /div> <
        ...
        <
        a href = "#"
        className = "flex items-start space-x-4 opacity-100" >
        <
        img className = "h-12 mt-1 rounded-lg overflow-hidden"
        ...
        strong className = "font-semibold block mt-2 text-sm text-gray-400" > 2019 - 10 - 21 < /strong> <
        /div> <
        /a> <
        a href = "#"
        ...
        /a> <
        /div> <
        div className = "text-sm mt-4" > ©2020 Company.All rights reserved. <
        /div> <
        /div> <
        /footer> <
        /div>
