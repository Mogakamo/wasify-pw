    ...
    render() {
        return(
            < div className = "relative flex items-center justify-center h-full overflow-x-hidden lg:overflow-hidden lg:h-screen" > {
                ...
                <
                img src = "./images/pattern-curve.svg"
            ...
            alt = "image 1" / >
                ...
                <
                p className = "font-light text-center paragraph text-darkBlue lg:max-w-lg lg:text-left" > “I’ ve been interested in coding
            for a
            while but never taken the
            jump, until now.I couldn’ t recommend this course enough.I’ m now in the job of my dreams and so excited about the future.” <
                /p> <
            ...
            alt = "image 1" / >
                ...
                div className = "relative flex flex-col items-center mt-16 lg:items-start lg:px-24 lg:justify-between quote lg:mt-0" >
                <
                p className = "font-light text-center paragraph text-darkBlue lg:max-w-lg lg:text-left" > “If you want to lay the best foundation possible I’ d recommend
