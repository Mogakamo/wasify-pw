  ...
  <footer className="bg-gray-800 text-gray-300 px-6 lg:px-8 py-12">
    <div className="max-w-screen-xl mx-auto grid md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-x-8">
      <div>
        ...
        <p className="mt-4">Let our designs work for you. And save valuable time during your next business adventure.</p>
      </div>
      <div>
        ...
        <nav className="mt-4">
          <ul className="space-y-2">
            ...
            <li>
              <a href="#" className="font-normal text-base hover:text-gray-100">Data Processing Agreement</a>
            </li>
            <li>
              <a href="#" className="font-normal text-base hover:text-gray-100">Privacy Statement</a>
            </li>
          </ul>
        </nav>
      </div>
      <div>
        ...
        <div className="space-y-4 md:space-y-6 mt-4">
          ...
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              <a href="#" className="hover:text-gray-100">support@company.com</a>
            </div>
          </div>
        </div>
      </div>
      <div>
        ...
        <div className="space-y-8 mt-4">
          <a href="#" className="flex items-start space-x-4 opacity-100">
            <img className="h-12 mt-1 rounded-lg overflow-hidden" src="./images/placeholder-white.svg" alt="White image placeholder" />
            <div className="flex-1">
