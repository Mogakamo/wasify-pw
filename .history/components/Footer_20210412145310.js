...
const Footer = () => {
  ...
  <footer className="bg-gray-800 text-gray-300 px-6 lg:px-8 py-12">
    <div className="max-w-screen-xl mx-auto grid md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-x-8">
      ...
      <div>
          {/**Pppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppaypal SDK */}
          <script
    src = "https://www.paypal.com/sdk/js?client-id=ARncOC1ZBkt72IwtTEYU7FahTOxnccxGAaFiWguz4HQcV8GKI5OIIAV7p37cr23hVlmfvu7f3mTkWzAq" >
  </script>
