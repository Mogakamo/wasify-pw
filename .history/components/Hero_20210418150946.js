            ...
            <div className="relative w-full h-full">
                ...
                <div className="relative px-4 xl:px-0  container mx-auto grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 pt-16 lg:pt-36 gap-8">
                    <div className="text-color">
                        ...
                        <button className="hover:opacity-90 text-lg w-full xl:text-3xl xl:w-10/12 mt-4 xl:mt-11 f-f-r py-6 bg-indigo-700 text-white text-bold">Let's Build</button>
                    </div>
                    <div className>
