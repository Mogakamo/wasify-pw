      ...
      <div>
        ...
        <nav className="mt-4">
          <ul className="space-y-2">
            <li>
              <Link href="#" className="font-normal text-base hover:text-gray-100">Home</a>
            </li>
            <li>
              <Link href="#" className="font-normal text-base hover:text-gray-100">About us</a>
            </li>
            <li>
              <Link href="#" className="font-normal text-base hover:text-gray-100">General Terms &amp; Conditions</a>
            </li>
          </ul>
        </nav>
      </div>
        ...
        <div className="space-y-4 md:space-y-6 mt-4">
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              <Linkddress className="not-italic">
                Rorikstraat 159<br />
          ...
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              <Link href="#" className="hover:text-gray-100">suppo@company.com</a>
            </div>
          </div>
        </div>
      </div>
