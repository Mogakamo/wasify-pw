      ...
      <div>
        ...
        <nav className="mt-4">
          <ul className="space-y-2">
            ...
            <li>
              <Link href="/p" className="font-normal text-base hover:text-gray-100">General Terms &amp; Conditions</Link>
            </li>
          </ul>
        </nav>
      </div>
      <div>
        ...
        <div className="space-y-4 md:space-y-6 mt-4">
          ...
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              <Link href="/" className="hover:text-gray-100">support@wasify.co.ke</Link>
            </div>
          </div>
        </div>
      </div>
