...
<div className="flex justify-center items-center h-screen md:-mx-4">
  <div className="w-full mx-20 bg-gray-100" style={{backgroundImage: 'url(http://bugspatrol.ancorathemes.com/wp-content/uploads/2016/07/main_bg.jpg)'}}>
    <h2 className="text-center font-bold text-3xl text-gray-100 pt-10">HAPPY CLIENTS ABOUT US</h2>            
        ...
        <div className="swiper-slide px-20 py-6 flex items-center justify-center">
          <div className="py-6">
            ...
            <div className="flex justify-center py-4">
              <img className="h-20 w-20 rounded-full" src="http://bugspatrol.ancorathemes.com/wp-content/uploads/2016/07/testimonials-3-75x75.jpg" />
            </div>
            <div className="text-sm flex justify-center text-gray-300">Julia Bredshow, NY</div>
          </div>
        </div>
