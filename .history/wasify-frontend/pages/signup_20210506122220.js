  ...
  <div className="max-w-md mx-auto bg-white rounded-lg overflow-hidden md:max-w-md">
    <div className="md:flex">
      <div className="w-full p-3 px-6 py-10">
        ...
        <div className="mt-4"> <button className="h-12 w-full bg-red-600 text-white rounded hover:bg-red-700">Click to proceed <i className="fa fa-long-arrow-right" /></button> </div>
      </div>
    </div>
  </div>
</div>
